...
<head>
  ...
  <title>ajib abdul kholiq | Dashboard</title>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo base_url();?>/aset/plugins/summernote/summernote-bs4.css">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="<?php echo base_url();?>/aset/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">LEAF'S</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url();?>/aset/dist/img/avatar.png"  class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">ajib's</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
                ...
                <a href="<?php echo site_url('anggota/main');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard</p>
                </a>
          </li>
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo site_url('anggota/out');?>" class="nav-link">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <td>
            <a href="<?php echo site_url('anggota/get_ubah/'.$row->id_anggota);?>" class="btn btn-sm  btn-warning">Ubah</a>
            <a href="<?php echo site_url('anggota/hapus/'.$row->id_anggota);?> "class="btn btn-sm btn-danger">Hapus</a></td>
</tr>
            <?php
           endforeach;
           ?>
           ...
           <a href="<?php echo site_url('anggota/tambah')?>" class="btn btn-primary" role="button">Tambah Data</a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 <a href="http://ajibkholiq.github.io">ajib abdul kholiq</a>.</strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> 1.9.08.2
    </div>
  </footer>
